...
class CloudFlare(object):
    class _base:
        ...
        def _call_with_no_auth(self, method, api_call_part1,
                               api_call_part2=None, api_call_part3=None,
        ...
        def _call_with_auth(self, method, api_call_part1, api_call_part2=None,
                            api_call_part3=None, identifier1=None,
                            identifier2=None, params=None, data=None):
        ...
        def _call_with_certauth(self, method, api_call_part1,
                                api_call_part2=None, api_call_part3=None,
                                identifier1=None, identifier2=None,
                                params=None, data=None):
            if self.CERTTOKEN is '':
                raise CloudFlareAPIError(0,
                                         'no email and/or cert token defined')
            headers = {
        ...
        def _call(self, method, headers, api_call_part1,
                  api_call_part2=None, api_call_part3=None,
                  identifier1=None, identifier2=None,
                  params=None, data=None):
            if api_call_part2 is not None or \
                ...
                if identifier2 is None:
                    ...
                    url = self.BASE_URL + '/' + api_call_part1 + '/' + \
                        identifier1 + '/' + api_call_part2 + '/' + identifier2
            else:
            ...
            if response_data['success'] is False:
                if self.logger:
                    self.logger.debug("response_data error: %d %s" % (
                        response_data['errors'][0]['code'],
                        response_data['errors'][0]['message']))
                raise CloudFlareAPIError(response_data['errors'][0]['code'],
                                         response_data['errors'][0]['message'])

            return response_data['result']

    class _unused:
        def __init__(self, base, api_call_part1,
                     api_call_part2=None, api_call_part3=None):
            # if self.logger:
            #    self.logger.debug("_unused %s,%s,%s" % (str(base),
            #                                            str(api_call_part1),
            #                                            str(api_call_part2)))
            self.base = base
    ...
    class _client_noauth:
        def __init__(self, base, api_call_part1,
                     api_call_part2=None, api_call_part3=None):
            # if self.logger:
            #    self.logger.debug("_client_noauth %s,%s,%s" % (
            #       str(base), str(api_call_part1), str(api_call_part2)))
            self.base = base
            self.api_call_part1 = api_call_part1
            self.api_call_part2 = api_call_part2
            self.api_call_part3 = api_call_part3

        def get(self, identifier1=None, identifier2=None,
                params=None, data=None):
    ...
    class _client_with_auth(object):
        def __init__(self, base, api_call_part1,
                     api_call_part2=None, api_call_part3=None):
            # if self.logger:
            #    self.logger.debug("_client_with_auth %s,%s,%s" % (
            #       str(base), str(api_call_part1), str(api_call_part2)))
            self.base = base
            self.api_call_part1 = api_call_part1
            self.api_call_part2 = api_call_part2
        ...
        def get(self, identifier1=None, identifier2=None,
                params=None, data=None):
            return self.base._call_with_auth('GET', self.api_call_part1,
                                             self.api_call_part2,
                                             self.api_call_part3,
                                             identifier1, identifier2,
                                             params, data)

        def patch(self, identifier1=None, identifier2=None,
                  params=None, data=None):
            return self.base._call_with_auth('PATCH', self.api_call_part1,
                                             self.api_call_part2,
                                             self.api_call_part3,
                                             identifier1, identifier2,
                                             params, data)

        def post(self, identifier1=None, identifier2=None,
                 params=None, data=None):
            return self.base._call_with_auth('POST', self.api_call_part1,
                                             self.api_call_part2,
                                             self.api_call_part3,
                                             identifier1, identifier2,
                                             params, data)

        def put(self, identifier1=None, identifier2=None,
                params=None, data=None):
            return self.base._call_with_auth('PUT', self.api_call_part1,
                                             self.api_call_part2,
                                             self.api_call_part3,
                                             identifier1, identifier2,
                                             params, data)

        def delete(self, identifier1=None, identifier2=None,
                   params=None, data=None):
            return self.base._call_with_auth('DELETE', self.api_call_part1,
                                             self.api_call_part2,
                                             self.api_call_part3,
                                             identifier1, identifier2,
                                             params, data)
    ...
    class _client_with_cert_auth(object):
        def __init__(self, base, api_call_part1,
                     api_call_part2=None, api_call_part3=None):
            # if self.logger:
            #    self.logger.debug("_client_with_cert_auth %s,%s,%s" % (
            #       str(base), str(api_call_part1), str(api_call_part2)))
            self.base = base
            self.api_call_part1 = api_call_part1
            self.api_call_part2 = api_call_part2
        ...
        def get(self, identifier1=None, identifier2=None,
                params=None, data=None):
            return self.base._call_with_certauth('GET', self.api_call_part1,
                                                 self.api_call_part2,
                                                 self.api_call_part3,
                                                 identifier1, identifier2,
                                                 params, data)
        ...
        def patch(self, identifier1=None, identifier2=None,
                  params=None, data=None):
            return self.base._call_with_certauth('PATCH', self.api_call_part1,
                                                 self.api_call_part2,
                                                 self.api_call_part3,
                                                 identifier1, identifier2,
                                                 params, data)
        ...
        def post(self, identifier1=None, identifier2=None,
                 params=None, data=None):
            return self.base._call_with_certauth('POST', self.api_call_part1,
                                                 self.api_call_part2,
                                                 self.api_call_part3,
                                                 identifier1, identifier2,
                                                 params, data)
        ...
        def put(self, identifier1=None, identifier2=None,
                params=None, data=None):
            return self.base._call_with_certauth('PUT', self.api_call_part1,
                                                 self.api_call_part2,
                                                 self.api_call_part3,
                                                 identifier1, identifier2,
                                                 params, data)
        ...
        def delete(self, identifier1=None, identifier2=None,
                   params=None, data=None):
            return self.base._call_with_certauth('DELETE', self.api_call_part1,
                                                 self.api_call_part2,
                                                 self.api_call_part3,
                                                 identifier1, identifier2,
                                                 params, data)
    ...
    def __init__(self, email=None, token=None, certtoken=None, debug=False):
        ...
        #   raise CloudFlareInternalError('You must at least specify an '
        #                                 'email and token string')
